...
main(int argc, char **argv) {
	...
	/* TODO: Initialize 'stream' here to read from a serial data stream, or whatever stream source is appropriate for your 
	application. See documentation for "Serial I/O" for your platform for details.*/
	/*待办事项：初始化“流”，从串行数据流中读取，或者任何适合您的应用程序的流源。有关详细信息，请参阅文档“串行输入/输出”文档。*/
	FILE *stream = fopen("COM4", "r");
	/* 3) Stuff each byte from the stream into the parser. Every time a Data Value is received, handleDataValueFunc() is called.*/
